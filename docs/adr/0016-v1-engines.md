...
Licenses, verified from GitHub SPDX: Semgrep engine LGPL-2.1, Gitleaks CLI MIT, Trivy Apache-2.0. None of the three is MIT-only. Semgrep-maintained *rules* use the Semgrep Rules License v1.0 (not OSI).

Superseded for SAST by ADR-0017: the SAST Engine is Opengrep, not Semgrep.
